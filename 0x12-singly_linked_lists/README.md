...
CAlgorithmData structure
    ...
    Weight: 1
    Project over - took place from Jun 30, 2023 6:00 AM to Jul 1, 2023 6:00 AM
    An auto review will be launched at the deadline

In a nutshell…

    Auto QA review: 41.0/43 mandatory & 7.8/12 optional
    Altogether:  157.33%
        Mandatory: 95.35%
        Optional: 65.0%
        Calculation:  95.35% + (95.35% * 65.0%)  == 157.33%
