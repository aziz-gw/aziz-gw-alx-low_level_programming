...
C
    ...
    Weight: 1
    Project over - took place from May 18, 2023 6:00 AM to May 19, 2023 6:00 AM
    An auto review will be launched at the deadline

In a nutshell…

    Auto QA review: 26.65/41 mandatory & 7.15/12 optional
    Altogether:  103.73%
        Mandatory: 65.0%
        Optional: 59.58%
        Calculation:  65.0% + (65.0% * 59.58%)  == 103.73%
